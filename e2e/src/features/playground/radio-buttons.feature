Feature: As as user I can interact with radio buttons
  ...
  Scenario: As a user I can interact and assert on radio buttons
    ...
    And the "female label" should not contain text "Male"
    And the "male label" should not contain text "Female"
